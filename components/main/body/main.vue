    ...
    <div class="lg:grid grid-rows-4 gap-4 flex flex-wrap">
      <div class="absolute top-[25%] left-[10%] grid grid-rows-1 gap-3">
        <img
          ...
          alt=""
        />
        <p class="text-white font-bold sm:text-3xl">
          Haftalik <span class="uppercase"> pubg</span> Turnuvasi~!
        </p>
        <p class="text-white leading-6 font-bold sm:text-xl">
          Haftalik <span class="uppercase"> pubg</span> turnuvasinda buyuk
          oduller kazanmaya basla!
        </p>
        <p class="text-white leading-6 font-bold sm:text-xl">
          Hemen lige katil ve gelismelerden haber dar ol.
        </p>
        <div class="flex flex-cols">
          <UButton label="Turnuvaya" color="red" size="xl"
            >Turnuvaya Katil</UButton
          >
          <UButton
            label="Turnuvaya"
            color=""
